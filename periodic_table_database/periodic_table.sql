...
--
-- Name: elements unique_col; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.elements
    ADD CONSTRAINT unique_col UNIQUE (name, symbol);
...
--
-- Name: properties ref_col; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT ref_col FOREIGN KEY (atomic_number) REFERENCES public.elements(atomic_number);
